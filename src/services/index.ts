...
export default class ServerConnection {
  ...
  static async getGrupos() {
    return await methodOlinda.get(
      '/Informes_ListaTarifasPorInstituicaoFinanceira/versao/v1/odata/GruposConsolidados?$top=100&$format=json'
    )
  }
  ...
  static async getServicos() {
    return await methodOlinda.get(
      '/Informes_ListaTarifaPorValores/versao/v1/odata/ServicosBancarios?$top=200&$format=json'
    )
  }
